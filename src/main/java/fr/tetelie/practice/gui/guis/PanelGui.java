...
public class PanelGui implements Gui {
    ...
    public Inventory inventory() {
        ...
        inv.setItem(22, new ItemBuilder(Material.LEASH).setName("§eTeam").addLoreLine("§7Create a party").toItemStack());
        ...
        inv.setItem(5, new ItemBuilder(Material.DIAMOND).setName("§ePass of fight").addLoreLine("§7Get rewards by playing on the server").toItemStack());
        return inv;
    }
}
